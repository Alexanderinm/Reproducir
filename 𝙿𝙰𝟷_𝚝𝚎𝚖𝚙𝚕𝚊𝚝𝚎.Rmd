...
github repo for rest of specialization: [Data Science Coursera](https://github.com/Alexanderinm/Reproducir)
...
download.file(fileUrl, destfile = paste0(getwd(), '/repdata_data_activity'))
unzip("repdata_data_activity",exdir = "data")
```
